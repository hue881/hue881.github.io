...
const AudioFX = (() => {
  ...
  const THEMES = {
    ...
    // Computational Thinking & Algorithms: marching, mechanical
    maze: {
    ...
    // Scratch building blocks: bright, curious, playful
    neuron: {
    ...
    // Python Basics: upbeat, poppy, ice-cream-truck cheerful
    recommend: {
    ...
    // Python: Logic & Games: dreamy, pixel-shimmer
    images: {
    ...
    // AI in Practice: bouncy, conversational
    chatbot: {
      tempo:0.15, type:'square',
    ...
    // Capstone & Shipping Code: serious, contemplative, minor feel
    bias: {
      tempo:0.18, type:'triangle',
